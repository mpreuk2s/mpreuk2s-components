    ...
    Instance: function () {
      ...
      this.addIC = (interactions) =>{
        ...
        interactions[generateKey]=  {
          ...
          headers: [
            {key:$.generateKey(),"headerName": "Content-Type", "headerValue": "application/json; charset=utf-8"}
          ],
      ...
      const events = {
        ...
        onAddAnswerMutlipleAnswer: (index) =>{
          ...
          config.interactions[index].multiple_answer_question.answers[answerkey]= {key:answerkey,"answer": "", "correct": false};
          this.renderAndReaddEvents()
        },
        ...
        onAddAnswerSinleAnswer: (index) =>{
          this.collectEditorValues();
          const answerkey = $.generateKey();
          config.interactions[index].single_answer_question.answers[answerkey]=  {key:answerkey,"answer": "", "correct": false};
          this.renderAndReaddEvents()
        },
