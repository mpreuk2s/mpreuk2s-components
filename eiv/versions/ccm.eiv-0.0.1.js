    ...
    const component = {
        ...
        config: {
            ...
            "interactions": [
                ...
                },
                {
                    ...
                    "httpDescription": "Make Call to : https://reqbin.com/echo/get/json",
                    "headers": [
                ...
                },
                {
                    ...
                    "text": "Guten Tag, asasd \n asdas asdaso aside awdo emdie asd iasd deawd."
                ...
                },
                {
                    ...
                    "url": "https://api.predic8.de/shop/products/",
                    "htmlAsValue": "<h2>An Unordered HTML List</h2>\n" +
                        "\n" +
                        "<ul>\n" +
                        "  <li>Coffee</li>\n" +
                        "  <li>Tea</li>\n" +
                ...
                },
                {
                    ...
                    "htmltext": "<h2>An Unordered HTML List</h2>\n" +
                        "\n" +
                        "<ul>\n" +
                        "  <li>Coffee</li>\n" +
                        "  <li>Tea</li>\n" +
                ...
                },
                {
                    ...
                    "interactionType": "html",
                    "url": "https://api.predic8.de/shop/products/",
                    "htmlAsValue": "<iframe srcdoc=\"<!DOCTYPE html>\n" +
                        "    <html>\n" +
                        "    <body>\n" +
                        "    \n" +
                    ...
                    "gaptext": "<h2><strong style=\"color: rgb(0, 0, 0);\">Ich bin ein Lückentext. </strong></h2><p> Lorem *ipsum* dolor sit *(a)m(e)t*, consectetur adipisici elit, sed eiusmod tempor incidunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquid ex ea commodi consequat. Quis aute iure reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint obcaecat cupiditat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>"
                },
                {
                    "interactionBehavior": "singleStop",
                    "timestart": 120,
                ...
                },
                {
                    ...
                    "imageUrl":"http://localhost:63342/Thesis/akless-components-master/eiv/resources/hbrswebsite.png",
                },
                {
                    "interactionBehavior": "singleStop",
                    "timestart": 30,
        ...
        Instance: function () {
            ...
            this.ready = async () => {
                ...
                this.settings.events = { 'onReady':event=>{ event.target && event.target.playVideo(); this.startTik()} };
            ...
            this.start = async () => {
                ...
                if (this.behave==="dynamic" || this.behave==="allwaysone" ){
           ...
           */
            ...
            this.multipleAnswerQuestion = interaction => {
                ...
                copiedHTML.class = copiedHTML.class + " radioQuestion"
                copiedHTML.inner = {"tag": "fieldset", "inner": []};
                copiedHTML.inner.inner.push( {  "tag": "h3", "class": "question",  "inner": interaction.multiple_answer_question.text  } );
                        ...
                        "inner": [
                            {
                                ...
                                "class": "row mt-3",
                                "style": "font-size: 11pt!important",
                                "inner": {"tag":"div", "class":"col12", "style":"white-space: pre-wrap;", "inner":interaction.httpDescription}
